...
\begin{multicols}{4}
    ...
    \end{enumerate}
\end{multicols}
\item The vapour pressure $p$ \brak{\text{in mm of Hg}} of a solid, at temperature $T$, is expressed by $\ln p = 23-3863/T$ and that of its liquid phase by $\ln p = 19-3063/T$. The triple point\brak{\text{in Kelvin}} of the material is
\begin{multicols}{4}
    \begin{enumerate}
        \item 185
        \item 190
...
\begin{multicols}{2}
    ...
    \end{enumerate}
\end{multicols}
\item If an atom is in the $\prescript{3}{}{D}_3$ state, the angle between the its orbital and spin angular momentum vectors \brak{\bar{L}\text{ and }\bar{S}} is 
\begin{multicols}{4}
    \begin{enumerate}
